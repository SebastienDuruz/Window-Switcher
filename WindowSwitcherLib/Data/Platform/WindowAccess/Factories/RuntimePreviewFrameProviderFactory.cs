...
/// </summary>
public sealed class RuntimePreviewFrameProviderFactory : IPreviewFrameProviderFactory
{
    private readonly ILinuxDependencyRegistry _linuxDependencies;

    public RuntimePreviewFrameProviderFactory(ILinuxDependencyRegistry? linuxDependencies = null)
    {
        _linuxDependencies = linuxDependencies ?? LinuxDependencies.Instance;
    }
